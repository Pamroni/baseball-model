...
class FangraphsBinaryDataset(Dataset):
    def __init__(self):
        super().__init__()
        self.csv_file_prefix = "./csv_data/fangraphs_binary"
        self.batter_days = 5
    ...
    def generate_training_data(self, game_id):
        ...
        label = self.get_result(game_response)
    ...
    def get_result(self, game_response):
    ...
    def get_batter_features(self, game_date, team_id, team_lineup):
        ...
        for player_id in team_lineup:
            ...
            if (
                ...
                and player_two_year is not None
            ):
                features.extend(player_season)
                features.extend(player_last_x)
                features.extend(player_two_year)
            else:
